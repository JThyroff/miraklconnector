...
class miraklconnector extends Module{
    public function __construct($name = null, Context $context = null)
    {
        ...
        $this->tabs = [[
            'name' => $tabNames, // One name for all langs
            'class_name' => MiraklSellManualTabController::TAB_CLASS_NAME,
            'visible' => true,
            'icon' => 'school',
    ...
    {
        return parent::install() && $this->manuallyInstallMiraklSellTab(); // TODO: Change the autogenerated stub
    }

    public function uninstall()
    {
        return parent::uninstall() &&$this->manuallyUnInstallMiraklSellTab(); // TODO: Change the autogenerated stub
    }
